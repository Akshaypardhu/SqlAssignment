...
insert into ord values(5,'1795/07/21',25.50,10) --cannot be inserted because The INSERT statement conflicted with the FOREIGN KEY constraint "FK__ord__Customer_id__37A5467C"
insert into ord values(6,'1787/11/27',14.40,9)  --cannot be inserted because The INSERT statement conflicted with the FOREIGN KEY constraint "FK__ord__Customer_id__37A5467C"
select * from ord
select * from cust
...
create view myview 
as
select prod.prod_name,orderitem.quantity,tblorder.order_number 
from prod,orderitem,tblorder
